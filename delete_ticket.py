...
def delete_tickets_menu(parent): 
    ...
    entry_delete = ctk.CTkEntry(delete_menu_frame, width=500, font=("Arial", 12), fg_color="#ffffff", text_color="#000000", placeholder_text="Delete tickets by ID", corner_radius=10)
