...
def register_ticket(parent, frame_show):
    ...
    save_button = tk.Button(buttons_frame, text="Save", bg="#2563eb", fg="white", width=15, cursor="hand2", command=lambda:(save_ticket(user_name_entry, problem_text, priority_box, parent) and show_tickets(frame_show) and delay_creation(parent, save_button)))
